...
//explode token
                    ...
                    curl_setopt_array($this->ch, array(
                        ...
                        CURLOPT_HTTPHEADER => array(
                            ...
                            'cookie:  _m_h5_tk=' . $token . '; _m_h5_tk_enc=' . $token_enc . '; ',
...
//calculating sign
//md5(`${token.split('_')[0]}&${time}&${appKey}&${body.data}`);

                    echo 'NEW Sign:' . $sign . '<br>';
    ...
    public function get_m_h5_tk()
    {
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://acs.youku.com/h5/mtop.com.youku.aplatform.weakget/1.0/?jsv=2.5.1&appKey=24679788');
        ...
        //return
        return array($m_h5_tk_matches[1], $m_h5_tk_enc_matches[1]);
