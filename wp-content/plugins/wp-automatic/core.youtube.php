	...
	class WpAutomaticYoutube extends wp_automatic {
		...
		function youtube_fetch_links($keyword, $camp) {
			...
			if (in_array ( 'OPT_YT_TRENDING', $camp_opt )) {
				...
				$search_url = "https://www.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=US&key=" . wp_automatic_trim( $wp_automatic_yt_tocken ) . "&maxResults=50";
